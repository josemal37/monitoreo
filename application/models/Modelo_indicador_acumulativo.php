...
/**
 * Description of modelo_indicador_acumulativo
 *
 * @author Jose
 */
class Modelo_indicador_acumulativo extends modelo_indicador_operativo {
    ...
    public function get_avance_indicador($id_indicador) {
        if (!is_numeric($id_indicador)) {
            ...
            $sql = "SELECT
                        SUM(AVANCE_INDICADOR_OPERATIVO.avance_op) AS 'total_avance'
                    FROM
