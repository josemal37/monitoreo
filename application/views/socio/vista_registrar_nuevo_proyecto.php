    ...
    <body>
        <div class="container">
            ...
            <div>
                ...
                ?>
                <?= form_open(base_url() . 'socio/registrar_nuevo_proyecto', Array('role' => 'form')) ?>
                <div class="form-group">
                    <label for="nombre_proyecto">Nombre del proyecto</label>
                    <?= form_input($nombre_proyecto) ?><p><?= form_error('nombre_proyecto') ?></p>
                </div>
                <div class="form-group">
                    <label for="descripcion_proyecto">Descripción</label>
                    <?= form_textarea($descripcion_proyecto) ?><p><?= form_error('descripcion_proyecto') ?></p>
                </div>
                <div class="form-group">
                    <label for="presupuesto_proyecto">Presupuesto (Bs.)</label>
                    <?= form_input($presupuesto_proyecto) ?><p><?= form_error('presupuesto_proyecto') ?></p>
                </div>
                <?= form_submit($submit) ?>
                <?= form_close() ?>
            </div>
