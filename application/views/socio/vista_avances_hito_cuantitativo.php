                                                                            ...
                                                                            <tbody>
                                                                                <?php foreach ($documentos[$i] as $documento): ?>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td width="10%"><a href="<?= base_url() . 'socio/descarga/' . $documento->archivo_documento_avance_hito_cn ?>" title="<?= $documento->archivo_documento_avance_hito_cn ?>" class="btn btn-success btn-xs btn-block">Ver documento</a></td>
                                                                                    </tr>
                                                                                <?php endforeach; ?>
                                                                            </tbody>
                                                                        </table>
