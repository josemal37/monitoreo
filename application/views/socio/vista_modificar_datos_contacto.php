...
<html lang="es">
    ...
    <body>
        <div class="container">
            ...
            <form action="<?= base_url() . 'socio/modificar_datos_contacto/' . $usuario->id_usuario ?>" id="formulario_contacto" role="form" method="post" accept-charset="utf-8" autocomplete="off">
