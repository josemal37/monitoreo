...
<html>
    ...
    <body>
            ...
            <div>
                ...
                <form action="<?= base_url() . 'socio/registrar_nuevo_indicador/' . $id_proyecto . '/' . $id_actividad ?>" id="indicador_operativo" role="form" method="post" accept-charset="utf-8">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="meta_op" id="meta_op" value="100" placeholder="Meta del indicador" class="form-control" required>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" name="no_aceptable_rango" id="no_aceptable_rango" value="0 - 25" readonly placeholder="Valor no aceptable" class="form-control" required>
                            <input type="hidden" name="no_aceptable_op" id="no_aceptable_op" value="25">
                            <p><?= form_error('no_aceptable_op') ?></p>
                        </div>
                        <div class="form-group col-lg-4">
                            <label for="limitado_op">Valor limitado</label>
                            <input type="text" name="limitado_rango" id="limitado_rango" value="25 - 75" readonly placeholder="Valor limitado" class="form-control" required>
                            <input type="hidden" name="limitado_op" id="limitado_op" value="75">
                            <p><?= form_error('limitado_op') ?></p>
                        </div>
                        <div class="form-group col-lg-4">
                            <label for="aceptable_op">Valor aceptable</label>
                            <input type="text" name="aceptable_rango" id="aceptable_rango" value="75 - 100" readonly placeholder="Valor aceptable" class="form-control" required>
                            <input type="hidden" name="aceptable_op" id="aceptable_op" value="100">
        ...
        <script type="text/javascript">
            ...
            $("#fecha_limite_indicador_op").datepicker({dateFormat: 'yy-mm-dd'}).datepicker('setDate', fecha_fin_ini);
