            ...
            <div>
                ...
                <form action="<?= base_url() . 'socio/registrar_nuevo_hito/' . $id_proyecto . '/' . $id_actividad ?>" id="formulario_hito" role="form" method="post" accept-charset="utf-8" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="descripcion_hito" id="descripcion_hito" rows="4" placeholder="Descripción" class="form-control"></textarea>
                        <p><?= form_error('descripcion_hito') ?></p>
                    </div>
                    <div id="datos_cuantitativos">
                        <div class="form-group">
                            <label for="meta_hito">Meta del hito</label>
                            <input type="number" name="meta_hito" id="meta_hito" placeholder="Meta del hito" class="form-control" required>
