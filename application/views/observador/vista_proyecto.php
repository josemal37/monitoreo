        ...
        <div class="container">
                            ...
                            <tbody>
                                <?php foreach ($proyecto_global->proyectos as $proyecto): ?>
                                    <tr>
                                        ...
                                        <td><a href="<?= base_url() . 'observador/ver_poa/' . $proyecto->id_proyecto ?>" class="btn btn-success btn-xs btn-block">Ver POA</a></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
            ...
            <?php else: ?>
                <div class="panel panel-warning">
                    ...
                    <div class="panel-body">
                        <p>Su institución todavía no tiene registrado ningún proyecto.</p>
                    </div>
                </div>
            <?php endif; ?>
        </div>
