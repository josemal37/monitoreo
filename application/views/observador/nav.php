    ...
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li <?php if($activo == "Proyectos"):?>class="active"<?php endif;?>><a href="<?= base_url() . 'observador/ver_proyecto'?>">Proyecto</a></li>
            </ul>
            <ul class="nav navbar-nav">
                <li <?php if($activo == "Gestion actual"):?>class="active"<?php endif;?>><a href="<?= base_url() . 'observador/ver_poa_gestion_actual'?>">POA gestión actual</a></li>
            </ul>
            <ul class="nav navbar-nav">
                <li <?php if($activo == "PRODOC"):?>class="active"<?php endif;?>><a href="<?= base_url() . 'observador/ver_reporte_prodoc'?>">PRODOC</a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="<?= base_url() . 'observador/modificar_datos_contacto/' . $id_usuario ?>">Cambiar datos de contacto</a></li>
                        <li><a href="<?= base_url() . 'observador/modificar_password/' . $id_usuario ?>">Cambiar password</a></li>
